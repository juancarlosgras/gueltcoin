...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Guelt " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"guelttools.com", "46.101.15.92"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"guelttools.com", "testnet-seed.guelttools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Guelt is probably already running."), addrBind.ToString().c_str());
        else
